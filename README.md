...
websites where different aspects of the UK COVID-19 response published data. It
is by no means comprehensive but aims to capture some of the main data so that
it is preserved.
...
`ukc19` is hosted on the [AI4CI r-universe](https://ai4ci.r-universe.dev/).
